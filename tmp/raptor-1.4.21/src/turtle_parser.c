...
{
       0,   194,   194,   197,   204,   208,   207,   224,   223,   236,
     239,   240,   244,   246,   248,   251,   254,   255,   258,   259,
     260,   263,   312,   316,   356,   400,   440,   484,   494,   512,
     589,   634,   640,   651,   651,   654,   695,   706,   710,   717,
     724,   728,   732,   745,   755,   769,   783,   797,   810,   820,
     835,   850,   865,   885,   908,   921,   937,   951,  1016,  1023,
    1123
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$accept", "Document", "colonMinusOpt", "graph", "$@1", "$@2",
  "graphName", "graphBody", "triplesList", "terminatedTriples",
  "statementList", "statement", "triples", "objectList", "itemList",
  "verb", "propertyList", "directive", "prefix", "base", "subject",
  "predicate", "object", "literal", "resource", "blank", "collection", 0
};
#endif
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (void *YYPARSE_PARAM, const char *yymsg, int yytype, YYSTYPE *yyvaluep)
#else
static void
yydestruct (YYPARSE_PARAM, yymsg, yytype, yyvaluep)
    void *YYPARSE_PARAM;
    const char *yymsg;
    int yytype;
    YYSTYPE *yyvaluep;
...
#line 176 "./turtle_parser.y"
  ...
  if((yyvaluep->uri))
    raptor_free_uri_v2(((raptor_parser*)rdf_parser)->world, (yyvaluep->uri));
};

/* Line 1000 of yacc.c  */
#line 1278 "turtle_parser.c"
	break;
      case 20: /* "\"blank node\"" */
...
#line 182 "./turtle_parser.y"
  ...
  if((yyvaluep->identifier))
    raptor_free_identifier((yyvaluep->identifier));
};

/* Line 1000 of yacc.c  */
#line 1363 "turtle_parser.c"
	break;
      case 42: /* "objectList" */

/* Line 1000 of yacc.c  */
#line 187 "./turtle_parser.y"
	{
...
#line 495 "./turtle_parser.y"
  ...
  if(!uri)
    YYERROR;
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, uri, RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 655 "./turtle_parser.y"
...
#if RAPTOR_DEBUG > 1  
  printf("directive @prefix %s %s\n",((yyvsp[(2) - (4)].string) ? (char*)(yyvsp[(2) - (4)].string) : "(default)"), raptor_uri_as_string_v2(((raptor_parser*)rdf_parser)->world, (yyvsp[(3) - (4)].uri)));
#endif
  ...
  raptor_free_uri_v2(((raptor_parser*)rdf_parser)->world, (yyvsp[(3) - (4)].uri));
...
/* Line 1455 of yacc.c  */
#line 746 "./turtle_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("literal + language string=\"%s\"\n", (yyvsp[(1) - (3)].string));
#endif

  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (yyvsp[(1) - (3)].string), NULL, (yyvsp[(3) - (3)].string));
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 756 "./turtle_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("literal + language=\"%s\" datatype string=\"%s\" uri=\"%s\"\n", (yyvsp[(1) - (5)].string), (yyvsp[(3) - (5)].string), raptor_uri_as_string_v2(((raptor_parser*)rdf_parser)->world, (yyvsp[(5) - (5)].uri)));
#endif

  if((yyvsp[(5) - (5)].uri)) {
    (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world,RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (yyvsp[(1) - (5)].string), (yyvsp[(5) - (5)].uri), (yyvsp[(3) - (5)].string));
    if(!(yyval.identifier))
      YYERROR;
  } else
...
#line 770 "./turtle_parser.y"
  ...
  if((yyvsp[(5) - (5)].uri)) {
    (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (const unsigned char*)(yyvsp[(1) - (5)].string), (yyvsp[(5) - (5)].uri), (yyvsp[(3) - (5)].string));
    if(!(yyval.identifier))
      YYERROR;
  } else
    (yyval.identifier)=NULL;
...
/* Line 1455 of yacc.c  */
#line 784 "./turtle_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("literal + datatype string=\"%s\" uri=\"%s\"\n", (yyvsp[(1) - (3)].string), raptor_uri_as_string_v2(((raptor_parser*)rdf_parser)->world, (yyvsp[(3) - (3)].uri)));
#endif

  if((yyvsp[(3) - (3)].uri)) {
    (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (yyvsp[(1) - (3)].string), (yyvsp[(3) - (3)].uri), NULL);
    if(!(yyval.identifier))
      YYERROR;
  } else
    (yyval.identifier)=NULL;
...
/* Line 1455 of yacc.c  */
#line 811 "./turtle_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("literal string=\"%s\"\n", (yyvsp[(1) - (1)].string));
#endif

  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (yyvsp[(1) - (1)].string), NULL, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 821 "./turtle_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, (yyvsp[(1) - (1)].string), uri, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 866 "./turtle_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_LITERAL, NULL, RAPTOR_URI_SOURCE_ELEMENT, NULL, string, uri, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 909 "./turtle_parser.y"
    {
#if RAPTOR_DEBUG > 1  
  printf("resource URI=<%s>\n", raptor_uri_as_string_v2(((raptor_parser*)rdf_parser)->world, (yyvsp[(1) - (1)].uri)));
#endif

  if((yyvsp[(1) - (1)].uri)) {
    (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, (yyvsp[(1) - (1)].uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
    if(!(yyval.identifier))
      YYERROR;
  } else
    (yyval.identifier)=NULL;
...
#line 922 "./turtle_parser.y"
  ...
  if((yyvsp[(1) - (1)].uri)) {
    (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, (yyvsp[(1) - (1)].uri), RAPTOR_URI_SOURCE_ELEMENT, NULL, NULL, NULL, NULL);
    if(!(yyval.identifier))
      YYERROR;
  } else
    (yyval.identifier)=NULL;
...
#line 938 "./turtle_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_ANONYMOUS, NULL, RAPTOR_URI_SOURCE_BLANK_ID, id, NULL, NULL, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
#line 952 "./turtle_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_ANONYMOUS, NULL, RAPTOR_URI_SOURCE_GENERATED, id, NULL, NULL, NULL);
  if(!(yyval.identifier)) {
    if((yyvsp[(2) - (3)].sequence))
      raptor_free_sequence((yyvsp[(2) - (3)].sequence));
    YYERROR;
...
#line 1024 "./turtle_parser.y"
  ...
  first_identifier=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, raptor_uri_copy_v2(((raptor_parser*)rdf_parser)->world, turtle_parser->first_uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!first_identifier)
    goto err_collection;
  rest_identifier=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, raptor_uri_copy_v2(((raptor_parser*)rdf_parser)->world, turtle_parser->rest_uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!rest_identifier)
    goto err_collection;
  ...
  object=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, raptor_uri_copy_v2(((raptor_parser*)rdf_parser)->world, turtle_parser->nil_uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!object)
    goto err_collection;
...
#line 1124 "./turtle_parser.y"
  ...
  (yyval.identifier)=raptor_new_identifier_v2(((raptor_parser*)rdf_parser)->world, RAPTOR_IDENTIFIER_TYPE_RESOURCE, raptor_uri_copy_v2(((raptor_parser*)rdf_parser)->world, turtle_parser->nil_uri), RAPTOR_URI_SOURCE_URI, NULL, NULL, NULL, NULL);
  if(!(yyval.identifier))
    YYERROR;
}
    break;
...
yyerrlab:
  ...
  if (yyerrstatus == 3)
	...
	{
	  yydestruct (YYPARSE_PARAM, "Error: discarding",
		      yytoken, &yylval);
	  yychar = YYEMPTY;
	}
    }
...
yyerrlab1:
  ...
  for (;;)
	...
	YYABORT;
      ...
      yydestruct (YYPARSE_PARAM, "Error: popping",
...
yyreturn:
  if (yychar != YYEMPTY)
     yydestruct (YYPARSE_PARAM, "Cleanup: discarding lookahead",
		 yytoken, &yylval);
  /* Do not reclaim the symbols of the rule which action triggered
  ...
  while (yyssp != yyss)
    {
      yydestruct (YYPARSE_PARAM, "Cleanup: popping",
		  yystos[*yyssp], yyvsp);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
